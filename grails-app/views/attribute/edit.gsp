...
<html>
    ...
    <body>
        ...
        <div id="edit-attribute" class="content scaffold-edit" role="main">
            ...
            <g:hasErrors bean="${this.attribute}">
            <ul class="errors" role="alert">
                <g:eachError bean="${this.attribute}" var="error">
                <li <g:if test="${error in org.springframework.validation.FieldError}">data-field-id="${error.field}"</g:if>><g:message error="${error}"/></li>
                </g:eachError>
            </ul>
            </g:hasErrors>
            <g:form resource="${this.attribute}" method="PUT">
                <g:hiddenField name="version" value="${this.attribute?.version}" />
                <fieldset class="form">
                    <f:all bean="attribute"/>
                </fieldset>

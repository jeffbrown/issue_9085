...
<html>
    ...
    <body>
        ...
        <div id="show-attribute" class="content scaffold-show" role="main">
            ...
            <f:display bean="attribute" />
            <g:form resource="${this.attribute}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.attribute}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
